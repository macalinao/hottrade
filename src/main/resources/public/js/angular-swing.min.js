...
! function t(e, n, i) {
  ...
  1: [
    ...
    function(t, e) {
      ...
      }(), i.title = "browser", i.browser = !0, i.env = {}, i.argv = [], i.on = n, i.addListener = n, i.once = n, i.off = n, i.removeListener = n, i.removeAllListeners = n, i.emit = n, i.binding = function() {
    ...
    function(t, e) {
      ! function(t, n, i, r) {
        ...
        function O(t) {
          ...
          return new(e = n ? n : _e ? Y : Te ? W : ve ? k : X)(t, C)
        }
        ...
        function D(t, e) {
          var n = e.center,
            ...
            r = t.prevDelta || {},
            s = t.prevInput || {};
          (e.eventType === Re || s.eventType === Ce) && (r = t.prevDelta = {
            x: s.deltaX || 0,
            y: s.deltaY || 0
          }, i = t.offsetDelta = {
            x: n.x,
        ...
        function X() {
          this.evEl = Ye, this.evWin = qe, this.allow = !0, this.pressed = !1, R.apply(this, arguments)
        }

        function Y() {
          this.evEl = He, this.evWin = ke, R.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }
        ...
        function U(t, e) {
          ...
          return e & (Ce | Ae) && (n = y(n.concat(i), "identifier", !0)), [n, i]
        }
        ...
        function H(t, e) {
          var n = S(t.touches),
            i = this.targetIds;
          if (e & (Re | Oe) && 1 === n.length) return i[n[0].identifier] = !0, [n, n];
          ...
          for (r = 0; r < o.length;) i[o[r].identifier] && a.push(o[r]), e & (Ce | Ae) && delete i[o[r].identifier], r++;
        ...
        function B(t) {
          this.id = E(), this.manager = null, this.options = h(t || {}, this.defaults), this.options.enable = f(this.options.enable, !0), this.state = on, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function oe(t, e) {
          e = e || {}, this.options = h(e, se.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = O(this), this.touchAction = new j(this, this.options.touchAction), ae(this, !0), a(e.recognizers, function(t) {
        ...
        c(X, R, {
          handler: function(t) {
            var e = Xe[t.type];
            e & Re && 0 === t.button && (this.pressed = !0), e & Oe && 1 !== t.which && (e = Ce), this.pressed && this.allow && (e & Ce && (this.pressed = !1), this.callback(this.manager, e, {
              pointers: [t],
              changedPointers: [t],
              pointerType: we,
              srcEvent: t
        ...
        t.MSPointerEvent && (He = "MSPointerDown", ke = "MSPointerMove MSPointerUp MSPointerCancel"), c(Y, R, {
          handler: function(t) {
            var e = this.store,
              n = !1,
            ...
            r & Re && (0 === t.button || o) ? 0 > a && (e.push(t), a = e.length - 1) : r & (Ce | Ae) && (n = !0), 0 > a || (e[a] = t, this.callback(this.manager, r, {
              pointers: e,
              changedPointers: [t],
              pointerType: s,
              srcEvent: t
        ...
        c(q, R, {
          handler: function(t) {
            ...
            if (e === Re && (this.started = !0), this.started) {
              ...
              e & (Ce | Ae) && n[0].length - n[1].length === 0 && (this.started = !1), this.callback(this.manager, e, {
                pointers: n[0],
                changedPointers: n[1],
                pointerType: Se,
                srcEvent: t
        ...
        c(W, R, {
          ...
          handler: function(t, e, n) {
            ...
            e & (Ce | Ae) && (this.mouse.allow = !0), this.callback(t, e, n)
          },
          destroy: function() {
            this.touch.destroy(), this.mouse.destroy()
          }
        });
        var Je = w(ce.style, "touchAction"),
          Ke = Je !== r,
          Qe = "compute",
          tn = "auto",
          en = "manipulation",
        ...
        B.prototype = {
          ...
          process: function(t) {
            var e = this.state,
              ...
              i = e & (an | un),
              r = this.attrTest(t);
            return i && (n & Ae || !r) ? e | ln : i || r ? n & Ce ? e | hn : e & an ? e | un : an : pn
          }
        }), c(Q, K, {
          defaults: {
            event: "pan",
          ...
          process: function(t) {
            ...
            if (this._input = t, !i || !n || t.eventType & (Ce | Ae) && !r) this.reset();
            else if (t.eventType & Re) this.reset(), this._timer = s(function() {
              this.state = cn, this.tryEmit()
            }, e.time, this);
            else if (t.eventType & Ce) return cn;
            return pn
          },
          reset: function() {
          ...
          emit: function(t) {
            this.state === cn && (t && t.eventType & Ce ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = de(), this.manager.emit(this.options.event, this._input)))
          }
        }), c(ne, K, {
          defaults: {
            event: "rotate",
          ...
          attrTest: function(t) {
            ...
            return n & (Le | Fe) ? e = t.velocity : n & Le ? e = t.velocityX : n & Fe && (e = t.velocityY), this._super.attrTest.call(this, t) && n & t.direction && t.distance > this.options.threshold && fe(e) > this.options.velocity && t.eventType & Ce
          },
          emit: function(t) {
            var e = $(t.direction);
          ...
          r.extend(u, {
            ...
            advance: function(t, e) {
              ...
              if (!n || !this._wasAtRest) {
                ...
                var w = !1;
                n && (this._wasAtRest = !0, w = !0), this.notifyPositionUpdated(y, w)
              }
            },
      ...
      (function(t) {
        function n() {
          ...
          return t.on = function(t, n) {
            return e[t] = e[t] || [], e[t].unshift(n), this
          }, t.trigger = function(t, n) {
            var i, r = e[t];
            if (r)
              for (i = r.length; i--;) r[i](n)
          }, t
        }
    ...
    function(t, e) {
      ...
      a.randomInt = function(t, e) {
        ...
        var o, a, u, h = {},
          ...
          f = i(),
          d = t.springSystem(),
          g = d.createSpring(250, 10),
          m = d.createSpring(500, 20),
          v = {},
          _ = {
            x: 0,
            y: 0
          };
        return o = c.throwOutDistance(c.minThrowOutDistance, c.maxThrowOutDistance), mc = new r.Manager(e, {
          recognizers: [
            [r.Pan, {
              threshold: 2
            }]
          ]
        }), n.appendToParent(e), e.addEventListener("mousedown", function() {
          n.appendToParent(e), f.trigger("dragstart", {
            target: e
          })
        }), mc.on("panmove", function(t) {
          var i = _.x + t.deltaX,
            r = _.y + t.deltaY,
            s = c.rotation(i, r, l, p, c.maxRotation);
          n.transform(e, i, r, s), f.trigger("dragmove", {
            target: e,
            throwOutConfidence: n.throwOutConfidence(i, l),
            throwDirection: 0 > i ? n.DIRECTION_LEFT : n.DIRECTION_RIGHT
          })
        }), mc.on("panend", function(t) {
          var n = _.x + t.deltaX,
            i = _.y + t.deltaY;
          c.isThrowOut(n, l) ? h.throwOut(n, i) : h.throwIn(n, i), f.trigger("dragend", {
            target: e
          })
        }), g.addListener({
          onSpringUpdate: function(t) {
            var e = t.getCurrentValue(),
              n = s.MathUtil.mapValueInRange(e, 0, 1, v.fromX, 0),
              i = s.MathUtil.mapValueInRange(e, 0, 1, v.fromY, 0);
            a(n, i)
          }
        }), m.addListener({
          onSpringUpdate: function(t) {
            var e = t.getCurrentValue(),
              n = s.MathUtil.mapValueInRange(e, 0, 1, v.fromX, o * v.direction),
              i = v.fromY;
            a(n, i)
          }
        }), a = function(t, i) {
          var r = c.rotation(t, i, l, p, c.maxRotation);
          _.x = t, _.y = i, n.transform(e, t, i, r)
        }, h.on = f.on, h.throwIn = function(t, e) {
          u(n.THROW_IN, t, e)
        }, h.throwOut = function(t, e) {
          u(n.THROW_OUT, t, e)
        }, h.destroy = function() {
          mc.destroy(), g.destroy(), m.destroy()
        }, u = function(t, i, r) {
          if (v.fromX = i, v.fromY = r, v.direction = v.fromX < 0 ? n.DIRECTION_LEFT : n.DIRECTION_RIGHT, t == n.THROW_IN) g.setCurrentValue(0).setAtRest().setEndValue(1), f.trigger("throwin", {
            target: e,
            throwDirection: v.direction
          });
          else {
            if (t != n.THROW_OUT) throw new Error("Invalid throw event.");
            m.setCurrentValue(0).setAtRest().setVelocity(100).setEndValue(1), f.trigger("throwout", {
              target: e,
              throwDirection: v.direction
            }), v.direction == n.DIRECTION_LEFT ? f.trigger("throwoutleft", {
              target: e,
              throwDirection: v.direction
        ...
        return t = t || {}, t.isThrowOut = t.isThrowOut ? t.isThrowOut : n.isThrowOut, t.throwOutConfidence = t.throwOutConfidence ? t.throwOutConfidence : n.throwOutConfidence, t.throwOutDistance = t.throwOutDistance ? t.throwOutDistance : n.throwOutDistance, t.minThrowOutDistance = t.minThrowOutDistance ? t.minThrowOutDistance : 400, t.maxThrowOutDistance = t.maxThrowOutDistance ? t.maxThrowOutDistance : 500, t.rotation = t.rotation ? t.rotation : n.rotation, t.maxRotation = t.maxRotation ? t.maxRotation : 20, t.transform = t.transform ? t.transform : n.transform, t
      }, n.transform = function(t, e, n, i) {
        t.style[o("transform")] = "translate(" + e + "px, " + n + "px) rotate(" + i + "deg)"
      }, n.appendToParent = function(t) {
        var e = t.parentNode,
          n = e.querySelectorAll("li"),
          i = [].slice.apply(n).indexOf(t);
        i + 1 != n.length && (e.removeChild(t), e.appendChild(t))
      }, n.throwOutConfidence = function(t, e) {
        return Math.min(Math.abs(t) / e, 1)
      }, n.isThrowOut = function(t, e) {
        return 1 == n.throwOutConfidence(t, e)
      }, n.throwOutDistance = function(t, e) {
        return a.randomInt(t, e)
      }, n.rotation = function(t, e, n, i, r) {
        var s = Math.min(Math.max(t / n, -1), 1),
          o = (e > 0 ? 1 : -1) * Math.min(Math.abs(e) / 100, 1),
          a = s * o * r;
        return a
      }, n.DIRECTION_LEFT = -1, n.DIRECTION_RIGHT = 1, n.THROW_IN = "in", n.THROW_OUT = "out", e.exports = n
    }, {
      hammerjs: 2,
      rebound: 3,
      sister: 4,
    ...
    function(t, e) {
      ...
      n = function(t) {
        ...
        return e.config = function() {
          ...
          var e = new s(this, t);
          return e.on("throwout", o.trigger.bind(null, "throwout")), e.on("throwoutleft", o.trigger.bind(null, "throwoutleft")), e.on("throwoutright", o.trigger.bind(null, "throwoutright")), e.on("throwin", o.trigger.bind(null, "throwin")), e.on("dragstart", o.trigger.bind(null, "dragstart")), e.on("dragmove", o.trigger.bind(null, "dragmove")), e.on("dragend", o.trigger.bind(null, "dragend")), e
        }, e
      }, e.exports = n
    }, {
      "./card.js": 6,
  ...
  9: [
    ...
    function(t) {
      var e = t("swing");
      angular.module("gajus.swing", []).directive("swingStack", function() {
        return {
          restrict: "A",
          scope: {},
          controller: function() {
            ...
            t = e.Stack({
              throwOutConfidence: function(offset, element) {
                console.log('check throw: ' + offset + ' - ' + element);
                return offset > 100 ? 1 : 0;
              }
            }), this.add = function(e) {
              return t.createCard(e)
            }
          }
        }
        ...
        return {
          ...
          link: function(t, e, n, i) {
            var r = i.add(e[0]),
              s = ["throwout", "throwoutleft", "throwoutright", "throwin", "dragstart", "dragmove", "dragend"];
            angular.forEach(s, function(e) {
              r.on(e, function(n) {
                t["swingOn" + e.charAt(0).toUpperCase() + e.slice(1)]({
                  eventName: e,
                  eventObject: n
                })
              })
